...
export default function SectionHero(): JSX.Element {
    ...
    return (
        <section ref={ref} className='safe-x-padding bg-gray-900 text-white mt-10 mb-[172px]' aria-label='Hero Section'>
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    <motion.p
                        ...
                        aria-label="Welcome to Suraj's Portfolio"
                    >
                    ...
                    <motion.h2
                        ...
                        aria-label="DevOp Engineer And Software Dev"
                    >
                        DevOp Engineer And Software Dev
                    </motion.h2>
                    <motion.p
                        className='text-base font-medium text-center md:text-xl lg:text-2xl text-gray-100 xl:text-left'
                        aria-label="I'm Suraj Hemnani. A passionate DevOp Engineer And Software Dev based in Nagpur, Maharashtra, India"
                    >
                        I&apos;m Suraj Hemnani. A passionate DevOp Engineer And Software Dev based in Nagpur, Maharashtra, India.
                    </motion.p>
                </div>
                {/* second */}
                <div className='xl:order-2'>
                    <div className='relative flex items-center justify-center order-1 xl:justify-end'>
                        <div className='relative'>
                            <motion.div
                                className='relative w-[280px] h-[280px] md:w-[330px] md:h-[330px] lg:w-[480px] lg:h-[480px] rounded-xl backdrop-blur bg-gradient-l from-gray-400/20 via-white/20 to-gray-300/20 overflow-clip'
                            >
                                <AnimatedImage
