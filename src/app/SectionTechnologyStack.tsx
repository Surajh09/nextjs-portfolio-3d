...
const technologyStack = [
    ...
    {
        name: 'GoLang',
        image: assets.home.technologyStack.go,
    },
    {
        name: 'Java',
    ...
    {
        name: 'tensorflow',
        image: assets.home.technologyStack.tensorflow,
    },
    {
        name: "Express JS",
    ...
    {
        name: "Rust",
        image: assets.home.technologyStack.rust,
    ...
    {
        name: "Django",
        image: assets.home.technologyStack.django,
...
export default function SectionTechnologyStack() {
    ...
    return (
        <section ref={ref} className={`safe-x-padding text-white ${styles.sectionDistance}`}>
